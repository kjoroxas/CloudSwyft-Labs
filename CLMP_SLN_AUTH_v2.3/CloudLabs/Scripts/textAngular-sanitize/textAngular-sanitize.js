...
var htmlAttrs = makeMap('abbr,align,alt,axis,bgcolor,border,cellpadding,cellspacing,class,clear,'+
    ...
    'id,ismap,lang,language,margin,nohref,nowrap,padding,rel,rev,rows,rowspan,rules,'+
...
var svgAttrs = makeMap('accent-height,accumulate,additive,alphabetic,arabic-form,ascent,' +
    ...
    'keySplines,keyTimes,lang,margin,marker-end,marker-mid,marker-start,markerHeight,markerUnits,' +
    'markerWidth,mathematical,max,min,offset,opacity,orient,origin,overline-position,' +
    'overline-thickness,padding,panose-1,path,pathLength,points,preserveAspectRatio,r,refX,refY,' +
